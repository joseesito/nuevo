    	...
    	@csrf
         ...
         <div class="row">
		    <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <div class="form-group">
		            <strong>Horas:</strong>
		            <input type="number" name="hours" class="form-control" placeholder="Name">
		        </div>
                <div class="form-group">
		            <strong>Nota minima:</strong>
		            <input type="number" name="grade_min" class="form-control" placeholder="Name">
		        </div>
                <div class="form-group">
                ...
                <div class="form-group" >
                    ...
                    <input type="text" class="form-control" name="certificate" placeholder="Name">
                </div>
                <div class="input-group">
                    <strong>Vigencia</strong>
                    <input type="number" id="txtname" name="validity" class="form-control" placeholder="Name" >
